...
mixin _$SearchState {
  ...
  bool get isLoarding => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      idleList: null == idleList
          ...
          : idleList // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
      isLoarding: null == isLoarding
          ? _value.isLoarding
          : isLoarding // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$_SearchState implements _SearchState {
  ...
  @override
  final bool isLoarding;
  @override
  final bool isError;

  @override
  String toString() {
    return 'SearchState(searchResultList: $searchResultList, idleList: $idleList, isLoarding: $isLoarding, isError: $isError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isLoarding, isLoarding) ||
                other.isLoarding == isLoarding) &&
...
abstract class _SearchState implements SearchState {
  const factory _SearchState(
      {required final List<SearchResultData> searchResultList,
      required final List<Downloads> idleList,
      required final bool isLoarding,
